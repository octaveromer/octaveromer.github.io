!function(t, e, i, n) {
    ...
    function H(t, e) {
        ...
        if (e & (Pt | Ot) && 1 === i.length)
            ...
            [i, i];
        var s, r, o = T(t.changedTouches), a = [], l = this.target;
    ...
    function V(t, e) {
        ...
        U.call(this, e)) : t & (Rt | Mt) && U.call(this, e)
    }
    function U(t) {
    ...
    var dt = ["", "webkit", "Moz", "MS", "ms", "o"], pt = e.createElement("div"), ft = "function", vt = Math.round, mt = Math.abs, gt = Date.now, Tt;
    ...
    l(Y, I, {
        handler: function De(t) {
            ...
            e & Ot && 1 !== t.which && (e = Rt),
            this.pressed && (e & Rt && (this.pressed = !1),
    ...
    G.prototype = {
        set: function(t) {
            t == ae && (t = this.compute()),
            oe && this.manager.element.style && pe[t] && (this.manager.element.style[re] = t),
    ...
    J.prototype = {
        ...
        dropRecognizeWith: function(t) {
            return r(t, "dropRecognizeWith", this) ? this : (t = tt(t, this),
        ...
        canEmit: function() {
            for (var t = 0; t < this.requireFail.length; ) {
                if (!(this.requireFail[t].state & (Ce | fe)))
                    return !1;
                t++
            }
            return !0
        ...
        recognize: function(t) {
            var e = Tt({}, t);
            return h(this.options.enable, [this, e]) ? (this.state & (Te | ye | Ce) && (this.state = fe),
            this.state = this.process(e),
            void (this.state & (ve | me | ge | ye) && this.tryEmit(e))) : (this.reset(),
            void (this.state = Ce))
        },
        process: function(t) {},
    ...
    l(st, J, {
        ...
        emit: function(t) {
            this.state === Te && (t && t.eventType & Rt ? this.manager.emit(this.options.event + "up", t) : (this._input.timeStamp = gt(),
    ...
    l(ot, et, {
        ...
        attrTest: function(t) {
            ...
            return e & (qt | Ft) ? i = t.overallVelocity : e & qt ? i = t.overallVelocityX : e & Ft && (i = t.overallVelocityY),
...
$(document).ready(function() {
    ...
    function i(t, e, i) {
        ...
        // Afficher le bouton sur toutes les pages sauf la dernière
        if (e !== i) {
